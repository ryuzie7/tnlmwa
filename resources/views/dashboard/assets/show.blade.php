...
<div class="w-full px-4 py-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-6">
        ...
        <div class="mt-6 flex flex-col items-center">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-white mb-2">Asset QR Code</h2>
            <div class="bg-white dark:bg-gray-900 p-4 rounded shadow">
                {!! QrCode::size(200)->generate(route('assets.card.show', $asset->id)) !!}
            </div>
            <a href="{{ route('assets.qr.download', $asset->id) }}"
               class="mt-3 inline-block text-blue-600 dark:text-blue-400 text-sm hover:underline">
                Download QR
            </a>
        </div>
